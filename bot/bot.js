...
bot.start(async (ctx) => {
    const startText = '🤘 Добро пожаловать в бот стикеров для Телеграм. \n\n💣 Покупай стикеры и выигрывай денежные призы номиналом 2х и 3х от суммы покупки. \n\n🗝 В каждой комнате стикеры по разным ценам, выбери подходящуюю'
    ...
    await ctx.reply('👉 Нажми "Комнаты" в меню')
